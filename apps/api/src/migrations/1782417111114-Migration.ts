...
export class Migration1782417111114 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."job_applications_status_enum" AS ENUM('PENDING', 'VIEWED', 'SHORTLISTED', 'REJECTED', 'INTERVIEW', 'HIRED')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."interviews_status_enum" AS ENUM('PENDING', 'ACCEPTED', 'DECLINED', 'CANCELLED')`);
        ...
        await queryRunner.query(`ALTER TABLE "job_posts" ADD CONSTRAINT "FK_c2d92b80c8ecec5d94d38fe95e8" FOREIGN KEY ("created_by") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "job_posts" ADD CONSTRAINT "FK_99666f01665f814e46461e21d3b" FOREIGN KEY ("company_id") REFERENCES "companies"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        ...
        await queryRunner.query(`ALTER TABLE "match_results" ADD CONSTRAINT "FK_035ab8efc325281d63faf2e38cd" FOREIGN KEY ("job_id") REFERENCES "job_posts"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        ...
        await queryRunner.query(`ALTER TABLE "job_applications" ADD CONSTRAINT "FK_99292c6cd0ed428e8f5b4e22958" FOREIGN KEY ("job_id") REFERENCES "job_posts"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "job_applications" ADD CONSTRAINT "FK_6ed185c3d4417cc1f5ec3f28e5d" FOREIGN KEY ("candidate_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "job_applications" ADD CONSTRAINT "FK_166e914b91ef8cefe623738ed22" FOREIGN KEY ("cv_id") REFERENCES "cv_documents"("id") ON DELETE SET NULL ON UPDATE CASCADE`);
        ...
        await queryRunner.query(`ALTER TABLE "interviews" ADD CONSTRAINT "FK_77f7078daea9f2b36e9ff761bd1" FOREIGN KEY ("application_id") REFERENCES "job_applications"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "interviews" ADD CONSTRAINT "FK_74f05927fc5dd3d5258bad5f609" FOREIGN KEY ("candidate_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "interviews" ADD CONSTRAINT "FK_978934041f0a0d6e083c7c7e72e" FOREIGN KEY ("recruiter_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "candidate_profiles" ADD CONSTRAINT "FK_5a3673f11918bcea56f48549603" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "interviews" DROP CONSTRAINT "FK_978934041f0a0d6e083c7c7e72e"`);
        ...
        await queryRunner.query(`ALTER TABLE "job_applications" DROP CONSTRAINT "FK_166e914b91ef8cefe623738ed22"`);
        ...
        await queryRunner.query(`ALTER TABLE "job_posts" DROP CONSTRAINT "FK_c2d92b80c8ecec5d94d38fe95e8"`);
        ...
        await queryRunner.query(`DROP TYPE "public"."job_posts_seniority_level_enum"`);
