...
export class AiAnalyzerService {
  ...
  async analyzeCv(
    payload: AnalyzeCvDto,
    identity: AnalyzeIdentity,
  ): Promise<AnalyzerCvResultDto> {
  ...
  private async enforceAnalyzeCooldown(
    identity: AnalyzeIdentity,
  ): Promise<void> {
  ...
  private async markAnalyzeSuccess(identity: AnalyzeIdentity): Promise<void> {
    ...
    await Promise.all([
      this.setCooldownTimestamp(
        this.buildAccountCooldownKey(identity.userId),
        now,
      ),
      this.setCooldownTimestamp(
        this.buildDeviceCooldownKey(identity.deviceId),
        now,
      ),
    ]);
  }
  ...
  private async setCooldownTimestamp(
    key: string,
    timestamp: number,
  ): Promise<void> {
    try {
  ...
  private async getCachedResult(
    key: string,
  ): Promise<AnalyzerCvResultDto | null> {
    try {
  ...
  private async validateAnalyzerResult(
    payload: unknown,
  ): Promise<AnalyzerCvResultDto> {
